		...
		if ($results) {
			foreach ($results as $result) {
                ...
                if ($category_info['path_id'] != $category_info['category_id']) {
                    $product_link = $this->url->link('product/product', 'path=' . $category_info['path_id'] . '_' . $category_info['category_id'] . '&product_id=' . $result['product_id']);
                } else {
                    $product_link = $this->url->link('product/product', 'path=' . $category_info['category_id'] . '&product_id=' . $result['product_id']);
                }
